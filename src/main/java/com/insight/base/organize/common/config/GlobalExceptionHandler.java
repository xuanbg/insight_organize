package com.insight.base.organize.common.config;
...
public class GlobalExceptionHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.insight.base.organize.common.config.GlobalExceptionHandler.class);
